using SmsDemoApp.Application.Common.MappingConfigurations;
using SmsDemoApp.Application.Common.Validation;
using SmsDemoApp.Application.Features.Common;
...
public static class ApplicationServiceCollectionExtension
{
    ...
    public static IServiceCollection AddApplicationMediatorServices(this IServiceCollection services)
    {
        services.AddMediator(options =>
        {
            ...
            options.Namespace = "SmsDemoApp.Application.GeneratedMediatorServices";
        });
